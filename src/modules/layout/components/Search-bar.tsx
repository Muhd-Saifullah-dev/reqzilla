  ...
  return (
    <>
      <button
        ...
        className="relative flex flex-1 cursor-text items-center justify-between self-stretch rounded bg-zinc-800 px-4 py-2 text-gray-300 transition hover:bg-zinc-700 focus-visible:bg-zinc-700 overflow-hidden"
      >
