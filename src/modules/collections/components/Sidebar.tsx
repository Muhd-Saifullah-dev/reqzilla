...
import EmptyCollections from "./empty-collecions";
...
const TabbedSidebar = ({ currentWorkspace }: Props) => {
          ...
          <div className="h-screen w-full bg-zinc-950 text-zinc-100 flex flex-col">
            ...
            <div className="p-4 border-b border-zinc-800">
              <div className="relative">
                <Search className="absolute top-1/2 left-3 transform -translate-y-1/2 w-4 h-4 text-zinc-800" />
                <input
                  type="text"
  ...
  return (
    <div className="flex h-screen bg-zinc-900">
          ...
          <div
            ...
            className={`w-8 h-8 rounded-lg flex items-center justify-center cursor-pointer transition-colors ${
              activeTab === item.label
                ...
                : "text-zinc-400 hover:text-zinc-300 hover:bg-zinc-8000"
            }`}
          >
      ...
      <div className="flex bg-zinc-900 overflow-y-auto w-full">
        {renderTabContent()}
      </div>
