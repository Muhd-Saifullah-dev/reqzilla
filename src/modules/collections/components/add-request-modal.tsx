...
const SaveRequestToCollectionModal = ({
  ...
  const requestColorMap: Record<REQUEST_METHOD, string> = {
    [REQUEST_METHOD.GET]: "text-green-500",
    [REQUEST_METHOD.POST]: "text-indigo-500",
    [REQUEST_METHOD.PUT]: "text-yellow-500",
    [REQUEST_METHOD.DELETE]: "text-red-500",
    [REQUEST_METHOD.PATCH]: "text-orange-500",
  };
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="relative mb-3">
            <Search className="absolute top-1/2 transform -translate-y-1/2 w-4 h-4 text-zinc-500" />
            <Input
              type="text"
              placeholder="Search"
